...
import { getRoleIcon } from '../utils/authorityRoles';
          ...
          <table style={{
            ...
            <thead>
              <tr style={{ borderBottom: '2px solid #E0E0E0' }}>
                ...
                <th style={{ padding: '12px', textAlign: 'left', color: '#666', fontWeight: '600' }}>Area</th>
                <th style={{ padding: '12px', textAlign: 'left', color: '#666', fontWeight: '600' }}>Pincode</th>
                <th style={{ padding: '12px', textAlign: 'left', color: '#666', fontWeight: '600' }}>Role</th>
                <th style={{ padding: '12px', textAlign: 'left', color: '#666', fontWeight: '600' }}>Authority Role</th>
            ...
            <tbody>
              {allUsers.map((user, index) => (
                <tr key={user.id} style={{
                  ...
                  <td style={{ padding: '12px', color: '#666' }}>{user.area || '-'}</td>
                  <td style={{ padding: '12px', color: '#666', fontWeight: '600' }}>{user.pincode || '-'}</td>
                  <td style={{ padding: '12px' }}>
                    <span style={{
                      ...
                      {user.role === 'admin' ? 'authority' : user.role}
                    </span>
                  </td>
